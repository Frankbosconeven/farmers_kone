...
class FboSettings extends StatefulWidget {
  const FboSettings({ Key? key }) : super(key: key);

  @override
  _FboSettingsState createState() => _FboSettingsState();
}

class _FboSettingsState extends State<FboSettings> {
  @override
